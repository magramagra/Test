...
import tests.tgoogle.GoogleTest;
...
public class SimpleSearchTest extends GoogleTest {
    ...
    /**
     * Prosty test wyszukiwania w tgoogle
     *
     * @param text
     */
    @Test(dataProvider = "searchText")
    public void testSearchWeb(String text) {
        //otwarcie strony tgoogle i wyszukanie tekstu
